...
profile = os.environ["MITTENS_VECTOR_PROFILE"]
params = {
    "memory": "64M",
    "cpu_clock": "1GHz",
    "cpu_issue_width": 2,
...
build_mesh(
    ...
    images=[os.environ["MITTENS_VECTOR_ELF"]],
    statistics_path=os.environ["MITTENS_VECTOR_STATS"],
    verbosity=0,

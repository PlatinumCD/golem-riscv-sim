...
readonly RESULTS_ROOT="${GOLEM_BUILD_ROOT:-${TEST_DIR}/../../build}/tests/sculptor-ra-tree-model-suite/${MEMORY_BACKEND}"
...
readonly COMPILER_PYTHON="${GOLEM_INSTALL_ROOT:-${TEST_DIR}/../../install}/compiler-python/bin/python"
readonly TORCH_MLIR_PYTHON="${GOLEM_INSTALL_ROOT:-${TEST_DIR}/../../install}/torch-mlir/python_packages/torch_mlir"
mapfile -t CASES < <(

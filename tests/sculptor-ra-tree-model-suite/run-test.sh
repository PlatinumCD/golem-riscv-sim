...
"${LLVM}/bin/clang++" "${cxx_flags[@]}" -c "${TEST_DIR}/tile-main.cpp" \
...
printf 'case,mesh,digital_workers,balance_digital_work,active_tiles,sst_threads,sst_partitioner,simulated_time,wall_seconds\n%s,%sx%s,%s,%s,%s,%s,%s,%s,%s\n' \

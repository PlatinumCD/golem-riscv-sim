...
#define MITTENS_BRIDGE_VERSION UINT32_C(4)
...
static_assert(sizeof(MittensBridgeTxBurst) == 16392);
static_assert(sizeof(MittensBridgeRxBurst) == 16392);

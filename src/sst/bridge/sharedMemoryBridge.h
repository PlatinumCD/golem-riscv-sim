...
class SharedMemoryBridge final
{
  public:
    ...
    std::optional<MittensBridgeTxBurst> peekTransmitBurst(
    ...
    std::uint32_t receiveBurstWriteIndex() const noexcept;
    ...
    bool receiveDMACompletionAvailable() const noexcept;
